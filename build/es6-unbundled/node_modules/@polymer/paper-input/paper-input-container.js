...
`;template.setAttribute("style","display: none;");document.head.appendChild(template.content);(0,_polymerFn.Polymer)({_template:_htmlTag.html`
    <style>
      :host {
        display: block;
        padding: 8px 0;
